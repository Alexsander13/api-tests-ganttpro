...
1. **Clone and enter directory**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/api-tests-ganttpro.git
...
2. Under **Build and deployment**:
   ...
   - Folder: Select `/root`
3. Save settings
4. After workflow runs, reports available at: `https://YOUR_USERNAME.github.io/api-tests-ganttpro/`

## Test Reports

### Allure Report (Recommended)

Most comprehensive visual reporting:
...
Browser opens to `http://localhost:8000` with interactive report showing:
- Test results grouped by feature/story
...
### Allure Report Won't Load

**If using HTTP server** (`python open_allure.py`):
- Ensure server is running on port 8000
- Check no other service using port 8000: `lsof -i :8000`
- Browser should auto-open to `http://localhost:8000`

**If opening report directly** (file:// protocol):
- CORS restrictions prevent loading
- Use HTTP server instead: `python open_allure.py`
...
git remote add origin https://github.com/YOUR_USERNAME/api-tests-ganttpro.git
...
- [INSTRUCTIONS.md](INSTRUCTIONS.md) - Detailed test documentation and patterns
- [src/navigation/TEST_INDEX.md](src/navigation/TEST_INDEX.md) - Complete test index
- [API Specification](api_spec.json) - GanttPRO API details
...
1. Check [INSTRUCTIONS.md](INSTRUCTIONS.md) for detailed test documentation
2. Review existing tests for patterns and examples
3. Check [GitHub Issues](https://github.com/YOUR_USERNAME/api-tests-ganttpro/issues)
